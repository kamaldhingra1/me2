...
<ControlCard title="Across All "  category="Controls" maturity="Foundational">
<ColumnContainer>
  <ul>
    <li>Human users</li>
...
<ControlCard title="Key Controls "  category="Plan & Require" maturity="Foundational">
<ColumnContainer>
  <ul>
...
Key controls include:
<ControlCard title="Key Controls "  category="Collect & Ingest" maturity="Foundational">
<ColumnContainer>
  <ul>
...
Key controls include:
<ControlCard title="Key Controls "  category="Prepare and Label" maturity="Foundational">
<ColumnContainer>
  <ul>
...
Key controls include:
<ControlCard title="Key Controls " category="Train and Develop" maturity="Flagship">
<ColumnContainer>
  <ul>
...
Key controls include:
<ControlCard title="Key Controls "  category="Validate and Evaluate" maturity="Flagship">
<ColumnContainer>
<ul>
...
Key controls include:
<ControlCard title="Key Controls "  category="Deploy and Operate" maturity="Advanced">
<ColumnContainer>
<ul>
...
Key controls include:
<ControlCard title="Key Controls "  category="Monitor and Improve" maturity="Flagship">
<ColumnContainer>
<ul>
...
Key controls include:
<ControlCard title="Key Controls " category="Retire and Archive" maturity="Advanced">
<ColumnContainer>
<ul>
...
<ControlCard title="Zero Trust Controls "  category="Cross Cutting" maturity="Flagship">
...
<ControlCard title="Zero Trust Enablers "  category="Built-in & Automated" maturity="Flagship">
<ColumnContainer>
<ul>
  <li>Policy engine</li>
...
Controls include:
<ControlCard title="Attestation and Provenance "  category="Supply Chain Security" maturity="Flagship">
<ColumnContainer>
<ul>
...
Controls include:
<ControlCard title="AI Assurance and Validation "  category="AI Security" maturity="Flagship">
<ColumnContainer>
<ul>
 <li>Model cards</li>
  <li>System cards</li>
...
<ControlCard  title="Governance Controls"  category="Responsible AI" maturity="Intermediate">
<ColumnContainer>
<ul>
...
Controls include:
<ControlCard  title="Orchestration Safeguards"  category="Multi-Agent Security" maturity="Flagship">
<ColumnContainer>
<ul>
...
<ControlCard  title="Controls"  category="Enterprise Integration" maturity="Foundational">
<ColumnContainer>
<ul>
<li>SIEM</li>
<li>SOAR</li>
